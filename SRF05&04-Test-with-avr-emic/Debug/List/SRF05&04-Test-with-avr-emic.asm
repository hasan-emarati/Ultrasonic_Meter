...
_0x0:
	.DB  0x20,0x68,0x61,0x73,0x61,0x6E,0x20,0x65
	.DB  0x6D,0x61,0x72,0x61,0x74,0x69,0x20,0x0
	.DB  0x55,0x6C,0x74,0x72,0x61,0x73,0x6F,0x6E
	.DB  0x69,0x63,0x20,0x6D,0x65,0x74,0x65,0x72
	.DB  0x20,0x0,0x64,0x69,0x73,0x74,0x61,0x6E
	.DB  0x63,0x65,0x3D,0x0,0x63,0x6D,0x0,0x6F
	.DB  0x75,0x74,0x20,0x6F,0x66,0x20,0x72,0x61
	.DB  0x6E,0x67,0x65,0x20,0x20,0x20,0x20,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020060:
	.DB  0x1
...
; .FSTART _timer0_ovf_isr
	...
	ST   -Y,R30
; 0000 0014 overflow++;
	LDI  R26,LOW(_overflow)
	LDI  R27,HIGH(_overflow)
	CALL __GETD1P_INC
	__SUBD1N -1
	CALL __PUTDP1_DEC
...
; 0000 006F       Counterm=(overflowm*256)+TCNT0;
	LDS  R30,_overflowm
	LDS  R31,_overflowm+1
	LDS  R22,_overflowm+2
	LDS  R23,_overflowm+3
	CALL SUBOPT_0x2
	STS  _Counterm,R30
	STS  _Counterm+1,R31
	STS  _Counterm+2,R22
...
; 0000 0070       distancem=(Counterm/2)*34.32 ;
	...
	CALL __MULF12
	STS  _distancem,R30
	STS  _distancem+1,R31
	STS  _distancem+2,R22
	STS  _distancem+3,R23
; 0000 0071 
...
; 0000 0078        ftoa(distancem,1,lcd);
	LDS  R30,_distancem
	LDS  R31,_distancem+1
	LDS  R22,_distancem+2
	LDS  R23,_distancem+3
	CALL SUBOPT_0x6
